...
namespace ChessLogic
{
    public class Board
    {
        ...
        public IEnumerable<Position> PiecePosition()//all pieces
        {
            for(int r=0; r<8; r++)
            {
                    for(int c=0; c<8; c++)
        ...
        public IEnumerable<Position> PiecePositionForPlayer(Player player)
        {
        ...
        {
            return PiecePositionForPlayer(player.Opponent()).Any(pos =>
            {
        ...
        public bool InsufficientMaterial()
        {
            ...
            return IsKingVsKing(counting) || IsKingBishopVKing(counting) || IsKingKnightVKing(counting) || IsKingBishopVKingBishop(counting);
        }
        ...
        {
            return PiecePositionForPlayer(color).First(pos => this[pos].Type == type);
        }
        
        //threefold rule below
        ...
        public bool CanCaptureEnPassant(Player player)
        {
            ...
            {
                Player.White => new Position[] { skipPos + Direction.SouthWest, skipPos + Direction.SouthEast },//for opponent pawn, black side
                Player.Black => new Position[] { skipPos + Direction.NorthWest, skipPos + Direction.NorthEast },//white side
